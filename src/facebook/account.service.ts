...
export const ACCOUNTS = {
    ...
    // ],
    MJ: [
        907326030096105, 1027298821176435, 4722720184445228, 883796449276568, 1064471510891137,
        990271481933036, 1717704645291644, 1524385018052768, 1231710867432251, 1326615781460719,
    ],
    // MuscleCarJones: [
    ...
    //     1497617930434557,
    // ],
    // HGPS1: [525498509199404, 670748501374568, 1093954077956223],
};
